    ...
    <div className="w-full max-w-lg p-10 flex flex-col items-center pointer-events-auto glass-card animate-fade-scale transition-shadow duration-500 hover:shadow-[0_8px_32px_0_rgba(255,255,255,0.05)]">
      ...
      <div className="flex items-center gap-3 mb-10">
        <div className="w-8 h-8 bg-white flex items-center justify-center rounded-sm">
          <span className="text-black font-extrabold text-[18px] italic pr-0.5">N</span>
        </div>
        <span className="text-white font-semibold text-[18px] tracking-wide">NexBoard</span>
      </div>

      {/* Heading */}
      <h1 className="text-white text-3xl font-bold text-center tracking-tight mb-8">
      ...
      <div className="grid grid-cols-2 gap-4 w-full mb-8">
        ...
        >
          ...
          <span className="text-[#E4E4E5] text-[14px] font-medium tracking-tight">Login with Google</span>
        </a>
      </div>
    </div>
  );
